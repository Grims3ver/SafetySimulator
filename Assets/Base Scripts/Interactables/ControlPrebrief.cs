...
public class ControlPrebrief : MonoBehaviour
{
   ...
   //this bool flags whether the prebrief has been read or not, does not need to appear in inspector
    ...
    public void OnContinueClick()
    {
        ...
        else if (currentScene.name.Equals("Code_S_Hide") && clickCount == 0)
        {
            ...
            controller.MovementForbidden = true;
            ++clickCount;
            prebriefTextbox.text = "You will have a limited amount of time to successfully perform all the actions needed to HIDE. This means silencing loud objects, locking doors, covering windows, and hiding the player. " +
