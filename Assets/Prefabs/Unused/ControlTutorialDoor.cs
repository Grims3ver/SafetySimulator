...
public class ControlTutorialDoor : MonoBehaviour
{
    ...
    private void Update()
    {
        ...
        else if (colliding && !toolTip.barricadedDoorCoroutineRunning && doorIsBarricaded)
        {
        ...
        {
            //for the tutorial, always show the door 
